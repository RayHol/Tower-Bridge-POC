...
// v0.2 Congrats pop up timed after video plays. Next/previous locations added (not working correctly)
...
function changeMedia() {
    ...
    setTimeout(showCongratulationsPopup, 60000); // Set to 0 for immediate testing 60000 = 1 min
}
}
